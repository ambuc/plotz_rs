...
pub fn polygon_overlaps_point(
    ...
    for (index, pg_pt) in polygon.pts.iter().enumerate() {
        if pg_pt == point {
            return Ok(Some((PolygonOpinion::AtPoint(index, *point), *point)));
        }
    }
...
mod tests {
    ...
    #[test_case(Multiline([*A, *C, *E, *O, *Y]), *A, Some((nonempty![MultilineOpinion::AtPoint(0, *A)], *A)); "multiline point at index 0")]
    #[test_case(Multiline([*A, *C, *E, *O, *Y]), *E, Some((nonempty![MultilineOpinion::AtPoint(2, *E)], *E)); "multiline point at index 2")]
    #[test_case(Multiline([*A, *C, *E, *O, *Y]), *Y, Some((nonempty![MultilineOpinion::AtPoint(4, *Y)], *Y)); "multiline point at index 4")]
    #[test_case(Multiline([*A, *C, *E, *O, *Y]), *B, Some((nonempty![MultilineOpinion::AtPointAlongSharedSegment(0, *B, Percent::Val(0.5))], *B)); "multiline point along segment 0")]
    #[test_case(Multiline([*A, *C, *E, *O, *Y]), *D, Some((nonempty![MultilineOpinion::AtPointAlongSharedSegment(1, *D, Percent::Val(0.5))], *D)); "multiline point along segment 1")]
    #[test_case(Multiline([*A, *C, *E, *O, *Y]), *J, Some((nonempty![MultilineOpinion::AtPointAlongSharedSegment(2, *J, Percent::Val(0.5))], *J)); "multiline point along segment 2")]
    #[test_case(Multiline([*A, *C, *E, *O, *Y]), *T, Some((nonempty![MultilineOpinion::AtPointAlongSharedSegment(3, *T, Percent::Val(0.5))], *T)); "multiline point along segment 3")]
    ...
    #[test_case( Multiline([*C, *E, *O]), Segment(*D, *J), Some(( nonempty![ MultilineOpinion::AtPointAlongSharedSegment(0, *D, Percent::Val(0.5)), MultilineOpinion::AtPointAlongSharedSegment(1, *J, Percent::Val(0.5)) ], nonempty![ SegmentOpinion::AtPointAlongSegment(*D, Percent::Zero), SegmentOpinion::AtPointAlongSegment(*J, Percent::One) ],)); "segment bookends 2")]
    ...
    #[test_case( Multiline([*C, *D, *E]), Segment(*E, *D), Some(( nonempty![ MultilineOpinion::EntireSubsegment(1) ], nonempty![ SegmentOpinion::EntireSegment ])); "partial collision 04")]
    #[test_case( Multiline([*C, *D, *E]), Segment(*C, *E), Some(( nonempty![ MultilineOpinion::EntireSubsegment(0), MultilineOpinion::EntireSubsegment(1) ], nonempty![ SegmentOpinion::EntireSegment ])); "total collision 01")]
    ...
    #[test_case( Multiline([*C, *D, *E]), Segment(Point(0.5,2), Point(1.5,2)), Some(( nonempty![ MultilineOpinion::AlongSubsegmentOf(0, Segment(Point(0.5,2),Point(1,2))), MultilineOpinion::AlongSubsegmentOf(1, Segment(Point(1,2),Point(1.5,2))) ], nonempty![ SegmentOpinion::EntireSegment ])); "total collision half shift 01")]
    #[test_case(Multiline([*C, *D, *E]), Segment(Point(1.5,2), Point(0.5,2)), Some(( nonempty![ MultilineOpinion::AlongSubsegmentOf(0, Segment(Point(0.5,2),Point(1,2))), MultilineOpinion::AlongSubsegmentOf(1, Segment(Point(1,2),Point(1.5,2))) ], nonempty![ SegmentOpinion::EntireSegment ])); "total collision half shift 01 flip")]
    #[test_case(Multiline([*H, *J, *O]), Segment(*D, *N), Some((nonempty![MultilineOpinion::AtPointAlongSharedSegment(0, *I, Percent::Val(0.5))], nonempty![SegmentOpinion::AtPointAlongSegment(*I, Percent::Val(0.5))])); "at point on segment at point on segment 00")]
    #[test_case(Multiline([*H, *J, *O]), Segment(*I, *N), Some((nonempty![MultilineOpinion::AtPointAlongSharedSegment(0, *I, Percent::Val(0.5))], nonempty![SegmentOpinion::AtPointAlongSegment(*I, Percent::Zero)])); "at point on segment at point on segment 01")]
    #[test_case(Multiline([*H, *J, *O]), Segment(*D, *I), Some((nonempty![MultilineOpinion::AtPointAlongSharedSegment(0, *I, Percent::Val(0.5))], nonempty![SegmentOpinion::AtPointAlongSegment(*I, Percent::One)])); "at point on segment at point on segment 02")]
    #[test_case(Multiline([*M, *H, *J]), Segment(*D, *N), Some((nonempty![MultilineOpinion::AtPointAlongSharedSegment(1, *I, Percent::Val(0.5))], nonempty![SegmentOpinion::AtPointAlongSegment(*I, Percent::Val(0.5))])); "at point on segment at point on segment 03")]
    #[test_case(Multiline([*M, *H, *J]), Segment(*I, *N), Some((nonempty![MultilineOpinion::AtPointAlongSharedSegment(1, *I, Percent::Val(0.5))], nonempty![SegmentOpinion::AtPointAlongSegment(*I, Percent::Zero)])); "at point on segment at point on segment 04")]
    #[test_case(Multiline([*M, *H, *J]), Segment(*D, *I), Some((nonempty![MultilineOpinion::AtPointAlongSharedSegment(1, *I, Percent::Val(0.5))], nonempty![SegmentOpinion::AtPointAlongSegment(*I, Percent::One)])); "at point on segment at point on segment 05")]
    ...
    #[test_case(Multiline([*C, *D, *E]), Multiline([*C, *H, *M]), Some( ( nonempty![ MultilineOpinion::AtPoint(0, *C), ], nonempty![ MultilineOpinion::AtPoint(0, *C) ])); "AtPoint 0, AtPoint 0")]
    #[test_case( Multiline([*C, *D, *E]), Multiline([*M, *H, *C]), Some( ( nonempty![ MultilineOpinion::AtPoint(0, *C), ], nonempty![ MultilineOpinion::AtPoint(2, *C) ])); "AtPoint 0, AtPoint 2")]
    #[test_case( Multiline([*E, *D, *C]), Multiline([*M, *H, *C]), Some( ( nonempty![ MultilineOpinion::AtPoint(2, *C), ], nonempty![ MultilineOpinion::AtPoint(2, *C) ])); "AtPoint 2, AtPoint 2")]
    #[test_case( Multiline([*C, *I, *O]), Multiline([*M, *I, *E]), Some( ( nonempty![ MultilineOpinion::AtPoint(1, *I), ], nonempty![ MultilineOpinion::AtPoint(1, *I) ])); "AtPoint 1, AtPoint 1")]
    #[test_case( Multiline([*C, *O]), Multiline([*E, *M]), Some( ( nonempty![ MultilineOpinion::AtPointAlongSharedSegment(0, *I, Percent::Val(0.5)) ], nonempty![ MultilineOpinion::AtPointAlongSharedSegment(0, *I, Percent::Val(0.5)) ])); "crosshairs")]
    #[test_case( Multiline([*C, *D, *E]), Multiline([*C, *D, *I]), Some( ( nonempty![ MultilineOpinion::EntireSubsegment(0), ], nonempty![ MultilineOpinion::EntireSubsegment(0), ])); "partial collision, entire subsegment 0 0")]
    #[test_case( Multiline([*E, *D, *C]), Multiline([*I, *D, *C]), Some( ( nonempty![ MultilineOpinion::EntireSubsegment(1), ], nonempty![ MultilineOpinion::EntireSubsegment(1), ])); "partial collision, entire subsegment 1 1")]
    #[test_case( Multiline([*C, *D, *E]), Multiline([*D, *E, *J]), Some( ( nonempty![ MultilineOpinion::EntireSubsegment(1), ], nonempty![ MultilineOpinion::EntireSubsegment(0), ])); "partial collision, entire subsegment 1 0")]
    #[test_case( Multiline([*C, *D, *E]), Multiline([*E, *D, *C]), Some( ( nonempty![ MultilineOpinion::EntireSubsegment(0), MultilineOpinion::EntireSubsegment(1) ], nonempty![ MultilineOpinion::EntireSubsegment(1), MultilineOpinion::EntireSubsegment(0) ])); "partial collision, entire subsegment 01 01 flipped")]
    #[test_case( Multiline([*C, *D, *E, *J, *O]), Multiline([*C, *D, *I, *J, *O]), Some( ( nonempty![ MultilineOpinion::EntireSubsegment(0), MultilineOpinion::EntireSubsegment(3) ], nonempty![ MultilineOpinion::EntireSubsegment(0), MultilineOpinion::EntireSubsegment(3) ])); "shared segment, then diversion, then another shared segment")]
    #[test_case( Multiline([*C, *D, *E, *J, *O]), Multiline([*C, *D, *I, *J]), Some( ( nonempty![ MultilineOpinion::EntireSubsegment(0), MultilineOpinion::AtPoint(3, *J) ], nonempty![ MultilineOpinion::EntireSubsegment(0), MultilineOpinion::AtPoint(3, *J) ])); "shared segment, then diversion, then atpoint")]
    ...
    #[test_case(Polygon([*D, *H, *N, *J]), &D, Some((PolygonOpinion::AtPoint(0,  *D), *D)); "point at point of polygon 00")]
