...
mod tests {
    ...
    #[test_case(Multiline([*C, *E, *O]), (*C, *M), Some((nonempty![MultilineOp::Point(0, *C)], nonempty![SegmentOp::PointAlongSegment(*C, Zero)])); "at point at point 00")]
    #[test_case(Multiline([*E, *O, *M]), (*E, *C), Some((nonempty![MultilineOp::Point(0, *E)], nonempty![SegmentOp::PointAlongSegment(*E, Zero)])); "at point at point 01")]
    #[test_case(Multiline([*O, *M, *C]), (*O, *E), Some((nonempty![MultilineOp::Point(0, *O)], nonempty![SegmentOp::PointAlongSegment(*O, Zero)])); "at point at point 02")]
    #[test_case(Multiline([*C, *I, *O]), (*C, *M), Some((nonempty![MultilineOp::Point(0, *C)], nonempty![SegmentOp::PointAlongSegment(*C, Zero)])); "at point at point 03")]
    #[test_case(Multiline([*C, *E, *O]), (*M, *C), Some((nonempty![MultilineOp::Point(0, *C)], nonempty![SegmentOp::PointAlongSegment(*C, One)])); "at point at point 04")]
    #[test_case(Multiline([*E, *O, *M]), (*C, *E), Some((nonempty![MultilineOp::Point(0, *E)], nonempty![SegmentOp::PointAlongSegment(*E, One)])); "at point at point 05")]
    #[test_case(Multiline([*O, *M, *C]), (*E, *O), Some((nonempty![MultilineOp::Point(0, *O)], nonempty![SegmentOp::PointAlongSegment(*O, One)])); "at point at point 06")]
    #[test_case(Multiline([*C, *I, *O]), (*M, *C), Some((nonempty![MultilineOp::Point(0, *C)], nonempty![SegmentOp::PointAlongSegment(*C, One)])); "at point at point 07")]
    #[test_case(Multiline([*D, *I, *N]), (*C, *E), Some((nonempty![MultilineOp::Point(0, *D)], nonempty![SegmentOp::PointAlongSegment(*D, Val(0.5))])); "at point at point 08")]
    #[test_case(Multiline([*H, *I, *J]), (*M, *C), Some((nonempty![MultilineOp::Point(0, *H)], nonempty![SegmentOp::PointAlongSegment(*H, Val(0.5))])); "at point at point 09")]
    #[test_case(Multiline([*D, *I, *N]), (*I, *J), Some((nonempty![MultilineOp::Point(1, *I)], nonempty![SegmentOp::PointAlongSegment(*I, Zero)])); "at point at point 10")]
    #[test_case(Multiline([*D, *I, *N]), (*H, *I), Some((nonempty![MultilineOp::Point(1, *I)], nonempty![SegmentOp::PointAlongSegment(*I, One)])); "at point at point 11")]
    #[test_case(Multiline([*D, *I, *N]), (*H, *J), Some((nonempty![MultilineOp::Point(1, *I)], nonempty![SegmentOp::PointAlongSegment(*I, Val(0.5))])); "at point at point 12")]
    #[test_case(Multiline([*D, *I, *N]), (*N, *O), Some((nonempty![MultilineOp::Point(2, *N)], nonempty![SegmentOp::PointAlongSegment(*N, Zero)])); "at point at point 13")]
    #[test_case(Multiline([*D, *I, *N]), (*M, *N), Some((nonempty![MultilineOp::Point(2, *N)], nonempty![SegmentOp::PointAlongSegment(*N, One)])); "at point at point 14")]
    #[test_case(Multiline([*D, *I, *N]), (*M, *O), Some((nonempty![MultilineOp::Point(2, *N)], nonempty![SegmentOp::PointAlongSegment(*N, Val(0.5))])); "at point at point 15")]
    #[test_case( Multiline([*C, *E, *O]), (*C, *O), Some((nonempty![MultilineOp::Point(0, *C), MultilineOp::Point(2, *O) ], nonempty![ SegmentOp::PointAlongSegment(*C, Zero), SegmentOp::PointAlongSegment(*O, One)])); "segment bookends 1")]
    #[test_case( Multiline([*C, *E, *O]), (*D, *J), Some((nonempty![MultilineOp::PointAlongSegmentOf(0, *D, Val(0.5)), MultilineOp::PointAlongSegmentOf(1, *J, Val(0.5)) ], nonempty![ SegmentOp::PointAlongSegment(*D, Zero), SegmentOp::PointAlongSegment(*J, One)])); "segment bookends 2")]
    #[test_case( Multiline([*C, *D, *E]), (*C, *D), Some((nonempty![MultilineOp::EntireSubsegment(0)], nonempty![SegmentOp::EntireSegment])); "partial collision")]
    #[test_case( Multiline([*C, *D, *E]), (*D, *C), Some((nonempty![MultilineOp::EntireSubsegment(0)], nonempty![SegmentOp::EntireSegment])); "partial collision 02")]
    #[test_case( Multiline([*C, *D, *E]), (*D, *E), Some((nonempty![MultilineOp::EntireSubsegment(1)], nonempty![SegmentOp::EntireSegment])); "partial collision 03")]
    #[test_case( Multiline([*C, *D, *E]), (*E, *D), Some((nonempty![MultilineOp::EntireSubsegment(1)], nonempty![SegmentOp::EntireSegment])); "partial collision 04")]
    #[test_case( Multiline([*C, *D, *E]), (*C, *E), Some((nonempty![MultilineOp::EntireSubsegment(0), MultilineOp::EntireSubsegment(1) ], nonempty![ SegmentOp::EntireSegment ])); "total collision 01")]
    #[test_case( Multiline([*C, *D, *E]), (*E, *C), Some((nonempty![MultilineOp::EntireSubsegment(0), MultilineOp::EntireSubsegment(1) ], nonempty![ SegmentOp::EntireSegment ])); "total collision 01 flip")]
    #[test_case( Multiline([*C, *D, *E]), (Point(0.5,2), Point(1.5,2)), Some(( nonempty![ MultilineOp::SubsegmentOf(0, Segment(Point(0.5,2),Point(1,2))), MultilineOp::SubsegmentOf(1, Segment(Point(1,2), Point(1.5,2))) ], nonempty![SegmentOp::EntireSegment])); "total collision half shift 01")]
    #[test_case(Multiline([*C, *D, *E]), (Point(1.5,2), Point(0.5,2)), Some(( nonempty![ MultilineOp::SubsegmentOf(0, Segment(Point(0.5,2),Point(1,2))), MultilineOp::SubsegmentOf(1, Segment(Point(1,2), Point(1.5,2))) ], nonempty![SegmentOp::EntireSegment])); "total collision half shift 01 flip")]
    #[test_case(Multiline([*H, *J, *O]), (*D, *N), Some((nonempty![MultilineOp::PointAlongSegmentOf(0, *I, Val(0.5))], nonempty![SegmentOp::PointAlongSegment(*I, Val(0.5))])); "at point on segment at point on segment 00")]
    #[test_case(Multiline([*H, *J, *O]), (*I, *N), Some((nonempty![MultilineOp::PointAlongSegmentOf(0, *I, Val(0.5))], nonempty![SegmentOp::PointAlongSegment(*I, Zero)])); "at point on segment at point on segment 01")]
    #[test_case(Multiline([*H, *J, *O]), (*D, *I), Some((nonempty![MultilineOp::PointAlongSegmentOf(0, *I, Val(0.5))], nonempty![SegmentOp::PointAlongSegment(*I, One)])); "at point on segment at point on segment 02")]
    #[test_case(Multiline([*M, *H, *J]), (*D, *N), Some((nonempty![MultilineOp::PointAlongSegmentOf(1, *I, Val(0.5))], nonempty![SegmentOp::PointAlongSegment(*I, Val(0.5))])); "at point on segment at point on segment 03")]
    #[test_case(Multiline([*M, *H, *J]), (*I, *N), Some((nonempty![MultilineOp::PointAlongSegmentOf(1, *I, Val(0.5))], nonempty![SegmentOp::PointAlongSegment(*I, Zero)])); "at point on segment at point on segment 04")]
    #[test_case(Multiline([*M, *H, *J]), (*D, *I), Some((nonempty![MultilineOp::PointAlongSegmentOf(1, *I, Val(0.5))], nonempty![SegmentOp::PointAlongSegment(*I, One)])); "at point on segment at point on segment 05")]
