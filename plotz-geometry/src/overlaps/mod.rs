...
mod tests {
    ...
    #[test_case( Multiline([*C, *D, *E, *J, *O]), Multiline([*C, *D, *I, *J]), Some( ( nonempty![ MultilineOpinion::EntireSubsegment(0), MultilineOpinion::AtPoint { index: 3, at_point: *J } ], nonempty![ MultilineOpinion::EntireSubsegment(0), MultilineOpinion::AtPoint { index: 3, at_point: *J } ])); "shared segment, then diversion, then atpoint")]
