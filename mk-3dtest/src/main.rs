                    ...
                    if false {
                        objects.extend(
                            Cube(p3!(0, 0, 0), (0.7, 0.7, 1.0))
                                ...
                                .into_iter()
                                .map(|face| {
                                    StyledObj3::new(face).with_style(Style3d::new(&RED, 3.0))
                                }),
                        );
                        objects.extend(Cube(p3!(1, 0, 0), (0.7, 0.7, 1.0)).items.into_iter().map(
                            |face| StyledObj3::new(face).with_style(Style3d::new(&YELLOW, 3.0)),
                        ));
                    }
                    //
                    if false {
                        ...
                        for pg3d in [
                            ...
                            objects
                                .push(StyledObj3::new(pg3d).with_style(Style3d::new(&YELLOW, 3.0)));
                        }
                    }
                    objects
                };
